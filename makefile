...
WASM_FLAGS = -O3 -s WASM=1 -s ALLOW_MEMORY_GROWTH=1  -s EXTRA_EXPORTED_RUNTIME_METHODS='["ccall", "cwrap"]' --std=c++17  # WASM-specific flags 
...
PROD_TARGET = ChessAI
WASM_TARGET = ChessAI.html # Outputs an HTML file, can also be .js or .wasm
